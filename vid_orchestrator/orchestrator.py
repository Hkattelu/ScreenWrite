...
parse → fetch → generate, with comprehensive error handling and logging.
"""
...
class VideoOrchestrator:
    ...
    The orchestrator manages the pipeline: script parsing → asset fetching → FCPXML generation,
    ...
    def __init__(self, 
        ...
        if output_dir:
            ...
            self.output_dir = Path(tempfile.mkdtemp(prefix="vid_orchestrator_"))
    ...
    def cleanup(self) -> None:
        ...
        try:
            ...
            if self.output_dir and self.output_dir.name.startswith("vid_orchestrator_"):
                import shutil
